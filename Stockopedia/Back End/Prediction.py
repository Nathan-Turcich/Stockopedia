...
if __name__ == '__main__':
    ...
    for company in stockNames:
        ...
        cursor.execute("INSERT INTO Predictions (abbr, day1, day2, day3, day4, day5, day6, day7, day8, day9, day10, day11, day12, day13, day14, day15, day16, day17, day18, day19, day20, day21, day22, day23, day24, day25, day26, day27, day28, day29, day30) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (company, predictions[0], predictions[1], predictions[2], predictions[3], predictions[4], predictions[5], predictions[6], predictions[7], predictions[8], predictions[9], predictions[10], predictions[11], predictions[12], predictions[13], predictions[14], predictions[15], predictions[16], predictions[17], predictions[18], predictions[19], predictions[20], predictions[21], predictions[22], predictions[23], predictions[24], predictions[25], predictions[26], predictions[28], predictions[29], predictions[30]))
